...
def main():
    ...
    # winlen_test = 400
    # winshift_test = 200
    # preempcoeff_test=0.97
    # nfft_test=512
    # nceps_test=13
    # samplingrate_test=20000
    # liftercoeff_test=22
    # test_Data = data[0]['samples']

    # # plt.plot(test_Data)
    # # plt.show()
    # prev_frame = enframe(test_Data,winlen_test,winshift_test)
    # prev_preemph = preemp(prev_frame, preempcoeff_test)
    # prev_windowed = windowing(prev_preemph)
    # prev_spec = powerSpectrum(prev_windowed, nfft_test)
    # prev_mspec = logMelSpectrum(prev_spec, samplingrate_test)
    # prev_ceps = cepstrum(prev_mspec, nceps_test)

    # plt.subplot(2, 3, 1)
    # plt.pcolormesh(prev_frame)

    # plt.subplot(2, 3, 2)
    # plt.pcolormesh(prev_preemph)

    # plt.subplot(2, 3, 3)
    # plt.pcolormesh(prev_windowed)

    # plt.subplot(2, 3, 4)
    # plt.pcolormesh(prev_spec)

    # plt.subplot(2, 3, 5)
    # plt.pcolormesh(prev_mspec)

    # plt.subplot(2, 3, 6)
    # plt.pcolormesh(prev_ceps)
